...
import { SortColumn, SortDirection } from "../utilities/usersetup-sortable.directive";

interface SearchResult {
  countries: UsersModel[];
  total: number;
}
...
function matches(country: UsersModel, term: string, pipe: PipeTransform) {
  return (
...
export class OrdersService {
  ...
  private _countries$ = new BehaviorSubject<UsersModel[]>([]);
